...
## The skim-layer studies (2026-08-29) — Phase 1 of the evidence-backed plan

Brief: research verified reviewers spend 2–5 minutes at the screening stage; the case essays
(~4,000 words) serve the deep read but not that screen. These render the two Phase-1 decisions.
Branch: `prototype/skim-layer`. Evidence dossier: "The Five-Minute Screen" artifact.
